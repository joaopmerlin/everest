...
public class OAuthHelper {
    ...
    public RequestPostProcessor bearerToken(final String user) {
        return mockRequest -> {
            OAuth2AccessToken token = createAccessToken(user);
    ...
    OAuth2AccessToken createAccessToken(final String user) {
